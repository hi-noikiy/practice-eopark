<div class="footer">
    <div class="copyright">
        <p><a href="#"  data-toggle="modal" data-target="#feedback">反馈意见</a> | <a href="#">联系我们</a></p>
        <p>{{ config("set.siteBeian") }} | Copyright©{{ date("Y") }} <a href="{{config('set.siteRoot')}}">{{config("set.sitePath")}}</a> All Rights
            Reserved</p>
    </div>
    <div id="footer-end">
    </div>
